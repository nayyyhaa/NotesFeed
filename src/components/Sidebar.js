    ...
    <>
      <div className={`side-bar notefeed-sidebar w-20p ${showFilterBar ? "show-filter" : ""}`}>
        <div className="side-bar-title title row-flex p-v-4 p-h-3">
          <button className="btn primary-btn create-btn">Create Note</button>
          <p className="icon-toggle icon-btn sidebar-close rd-bdr grid-ctr colored-text" onClick={() => setShowFilterBar(false)}>
